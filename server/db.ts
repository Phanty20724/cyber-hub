  ...
  try {
    ...
    if (parseInt(rows[0].count) === 0) {
      await client.query(`
        ...
        ('PORTFOLIATHON INTRA 1.0', 'Dec 21-24, 2025', '72 Hours', 'Devpost', '100+', 'Our flagship portfolio competition. Build, innovate, and compete for exciting prizes.', 'Competition', 'upcoming', true),
